...
class Snack extends Food{
	...
	Snack(int price, int gram){
		super(price);		this.gram=gram;	}
}


class Apple extends Fruit{
   Apple(int price, double brix) {		super(price, brix);	}
...
class Peach extends Fruit{	
	Peach(int price, double brix) {		super(price, brix);	}
	@Override
	public String toString() {
		// TODO Auto-generated method stub
		return "복숭아";
...
class Coke extends Drink{	
	Coke(int price, int ml) {		super(price, ml);	}
	@Override
	public String toString() {
		// TODO Auto-generated method stub
		return "콜라";
...
class Cider extends Drink{	
	Cider(int price, int ml) {		super(price, ml);	}
	@Override
	public String toString() {
		// TODO Auto-generated method stub
		return "사이다";
...
class Biscuit extends Snack{	
	Biscuit(int price, int gram) {		super(price, gram);	}
	@Override
	public String toString() {
		// TODO Auto-generated method stub
		return "비스켓";
...
class Cookie extends Snack{	
	Cookie(int price, int gram) {		super(price, gram);	}
	@Override
	public String toString() {
		// TODO Auto-generated method stub
		return "쿠키";
